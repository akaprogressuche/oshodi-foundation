      ...
      <header className="sticky top-0 z-40 backdrop-blur bg-background/80 border-b border-border">
        <div className="mx-auto max-w-7xl px-6 lg:px-10 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <Link
              href="/get-involved"
              className="hidden xl:inline-flex items-center px-4 py-2 rounded-full bg-accent text-accent-foreground text-sm font-medium hover:opacity-90 transition-opacity"
            >
              Get Involved
            </Link>
            ...
            <button
              ...
              aria-expanded={open}
              className="xl:hidden p-2 -mr-2 inline-flex items-center justify-center text-foreground"
            >
              <svg
                width="24"
                height="24"
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed inset-0 z-30 xl:hidden bg-inverted-bg text-inverted-fg pt-20"
          >
